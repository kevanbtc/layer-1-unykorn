...
contract BufferPool is AccessControl, ReentrancyGuard {
     ...
     * @param standard Credit standard
     * @return bufferPercent Buffer percentage in basis points
     * @return totalDeposits Total deposited amount
     * @return totalWithdrawals Total withdrawn amount
     * @return currentBalance Current buffer balance
